          ...
          <li className='CourseItem item-1'>
            <a href='http://layoutbyexample.com'>
              ...
              <div className='CourseItem--Description'>
                <p>This course will start out covering the very basics of CSS Layout - box models, te display property,
                  sizing - because a strong foundation is key. You'll finish by mastering the best modern tools: Flexbox
